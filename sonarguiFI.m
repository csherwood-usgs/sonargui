...
%      singleton*.
%
%      H = SONARGUIFI returns the handle to a new SONARGUIFI or the handle to
%      the existing singleton*.
%
%      SONARGUIFI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SONARGUIFI.M with the given input arguments.
%
%      SONARGUIFI('Property','Value',...) creates a new SONARGUIFI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sonarguiFI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sonarguiFI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sonarguiFI
...
gui_State = struct('gui_Name',       mfilename, ...
   ...
   'gui_OpeningFcn', @sonarguiFI_OpeningFcn, ...
   'gui_OutputFcn',  @sonarguiFI_OutputFcn, ...
   'gui_LayoutFcn',  [] , ...
   'gui_Callback',   []);
...
% --- Executes just before sonarguiFI is made visible.
function sonarguiFI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sonarguiFI (see VARARGIN)

% Choose default command line output for sonarguiFI
...
function varargout = sonarguiFI_OutputFcn(hObject, eventdata, handles)
