...
% Last Modified by GUIDE v2.5 15-Nov-2010 10:09:04
...
[ra,hdg]=pcoord(xa,ya);
str = num2str(hdg);
%str = num2str(handles.instloc(2).pry(3));
...
save gui3_output.mat inst instloc tripod cmpss

% Update handles structure
guidata(hObject, handles);
save gui3_output.mat inst instloc tripod cmpss
% This sets up the initial plot - only do when we are invisible
% so window can get raised using gui3.
